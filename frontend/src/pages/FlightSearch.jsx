...
import { Plane, Calendar, CreditCard, Shield, Globe2, Compass } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <div className="relative pt-32 pb-40 px-6 lg:px-8 flex flex-col items-center justify-center min-h-[70vh] overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto w-full">
          ...
          >
            ...
            <span>Discover the World with TripSoul</span>
          </motion.div>
          ...
          >
            Experience seamless booking. Compare luxury and economy flights globally, curated for your ultimate comfort.
          </motion.p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 pb-24">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-4">Why Book With Us?</h2>
          <div className="w-20 h-1 bg-blue-600 mx-auto rounded-full"></div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            { icon: Compass, title: "Curated Destinations", desc: "Access premium flight routes to the world's most sought-after locations." },
            { icon: Calendar, title: "Ultimate Flexibility", desc: "Modify dates and compare fares effortlessly for the perfect itinerary." },
            { icon: CreditCard, title: "Unbeatable Value", desc: "We aggregate top airlines to guarantee you the most competitive rates." },
